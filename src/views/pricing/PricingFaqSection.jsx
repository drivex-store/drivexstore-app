...
import { getPricingFaqSectionData } from "@libs/sanity/queries/PricingPage/PricingFaqSectionData";

export default async function PricingFaqSection() {
  const data = await getPricingFaqSectionData();
  ...
  return (
    <section
      ...
      data-page-builder-section="pricingFaqSection"
